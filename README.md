...
node ./src/cli/index.ts --repo .
node ./src/cli/index.ts --session ~/.claude/projects/.../abc.jsonl
node ./src/cli/index.ts "React rendering and caching"
node ./src/cli/index.ts stats
node ./src/cli/index.ts profile
node ./src/cli/index.ts settings --language zh-CN --level senior --daily-goal 8
node ./src/cli/index.ts review
node ./src/cli/index.ts inspect-sources
```
